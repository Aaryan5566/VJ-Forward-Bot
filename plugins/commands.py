...
main_buttons = [[
    InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='https://t.me/Patrick_Bateman_r')
],[
    InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/requestmoviesgroup0'),
    InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/SevenX_Support')
],[
    InlineKeyboardButton('💝 Pᴀᴛʀɪᴄᴋ Bᴏᴛᴢ', url='https://t.me/SevenX_Support')
],[
